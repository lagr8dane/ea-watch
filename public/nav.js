// public/nav.js
// Shared navigation drawer. Load on every page with:
//   <script src="/nav.js"></script>
// Injects a hamburger button into the page header and a slide-in drawer.
// No dependencies. Detects current page and highlights active item.
...
(function () {
  ...
  drawer.innerHTML = `
    <div class="nav-drawer-header">
      ...
      <button class="nav-close" onclick="void(0)">×</button>
    </div>
    <div class="nav-items">
      ${NAV_ITEMS.map(item => {
  ...
  // -------------------------------------------------------------------------
  // Hamburger button — injected into the page header
  // -------------------------------------------------------------------------
  ...
  // Inject into header — append to .header-actions if it exists,
  // otherwise append directly to header
  function inject() {
    ...
    if (actions) {
      ...
      // For ea.html which has its own structure — insert before end of header
