...
// ---------------------------------------------------------------------------
// Timer (Clock app — best-effort from web only)
// config: { kind: 'timer', minutes: number, label?: string }
// Safari / macOS often reject query forms or ignore duration; EA web UI runs
// an in-page timer as the reliable path. This URL only opens the Timer tab.
// ---------------------------------------------------------------------------
