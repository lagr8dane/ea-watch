...
SPOTIFY_CLIENT_ID= / SPOTIFY_CLIENT_SECRET= (optional — EA “Play …”; register redirect on Spotify as `https://<your-app>/api/spotify/callback` — HTTPS production only, not localhost)
